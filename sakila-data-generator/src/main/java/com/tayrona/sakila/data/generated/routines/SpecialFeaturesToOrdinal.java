...
public class SpecialFeaturesToOrdinal extends AbstractRoutine<Integer> {
    ...
    public SpecialFeaturesToOrdinal() {
        super("SPECIAL_FEATURES_TO_ORDINAL", Sakila.SAKILA, SQLDataType.INTEGER);

...
/**
 * Convenience access to all Domains in SAKILA.
 */
@SuppressWarnings({ "all", "unchecked", "rawtypes" })
public class Domains {

    /**
     * The domain <code>SAKILA.SPECIAL_FEATURES</code>.
     */
    ...
    /**
     * The domain <code>SAKILA.YEARVALUE</code>.
     */
    ...
    private static final Schema schema() {
        return new LazySchema(DSL.name("SAKILA"), DSL.comment(""), () -> Sakila.SAKILA);
    }
}

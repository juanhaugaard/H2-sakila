...
public class EnumToOrdinal extends AbstractRoutine<Integer> {
    ...
    public EnumToOrdinal() {
        super("ENUM_TO_ORDINAL", Sakila.SAKILA, SQLDataType.INTEGER);

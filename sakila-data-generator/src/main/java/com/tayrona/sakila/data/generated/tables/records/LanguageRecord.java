...
public class LanguageRecord extends UpdatableRecordImpl<LanguageRecord> implements Record3<Long, String, OffsetDateTime> {
    ...
    @Override
    public LanguageRecord values(Long value1, String value2, OffsetDateTime value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public LanguageRecord(Long languageId, String name, OffsetDateTime lastUpdate) {
        super(Language.LANGUAGE);

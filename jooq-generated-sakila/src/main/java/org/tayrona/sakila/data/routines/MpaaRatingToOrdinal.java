...
public class MpaaRatingToOrdinal extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1L;

    /**
     * The parameter <code>PUBLIC.MPAA_RATING_TO_ORDINAL.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>PUBLIC.MPAA_RATING_TO_ORDINAL.P1</code>.
     */
     ...
     */
    public MpaaRatingToOrdinal() {
        super("MPAA_RATING_TO_ORDINAL", Public.PUBLIC, SQLDataType.INTEGER);
